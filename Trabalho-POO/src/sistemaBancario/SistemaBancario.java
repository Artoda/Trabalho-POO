...
=======
		ListaClientes.add(new Cliente("JoÃ£o", "123.456.789-01", 1235));
...
=======
			System.out.println("2 - Login FuncionÃ¡rio\n");
			System.out.println("3 - Encerrar sistema\n");
			System.out.print("OpÃ§Ãµes: ");
...
=======
		System.out.println("-------------------------   Menu funcionÃ¡rio:  -----------------------------\n");
...
=======
	public static void menuCliente() {
		try {
			...
			if (posicao1 == -5) {
				System.out.print("AgÃªncia nÃ£o encontrada!\n");
			} else {
				System.out.print("Conta: ");
				conta = read.nextInt();
				for (int i = 0; i < listaAgencias.get(posicao1).getListaContas().size(); i++) {
				...
				if (posicao2 == -5) {
					System.out.println("Conta ou senha invÃ¡lida!");
				}
			}
			...
			if (posicao1 != -5 && posicao2 != -5) {
				...
				while (escolha != 6) {
					System.out.println("OperaÃ§Ã£o desejada \n");
					System.out.println("1 - Saque\n");
					System.out.println("2 - Deposito\n");
					System.out.println("3 - TranferÃªncia\n");
					System.out.println("4 - Extrato\n");
					System.out.println("5 - SimulaÃ§Ã£o poupanÃ§a\n");
					System.out.println("6 - Encerrar\n");
					System.out.print("OpÃ§Ã£o: ");
					escolha = read.nextInt();
					...
					case 2:
						if (listaAgencias.get(posicao1).getListaContas().get(posicao2).getTipoConta().name()
								.equals("CORRENTE")) {
							System.out.println("O depÃ³sito feito em contas corrente tem uma taxa de R$0,10.");
						}
						System.out.println("Qual o valor desejado para o depÃ³sito: ");
						valor = read.nextDouble();
						listaAgencias.get(posicao1).getListaContas().get(posicao2).Deposito(valor);
						break;
					case 3:
						if (listaAgencias.get(posicao1).getListaContas().get(posicao2).getTipoConta().name()
								.equals("CORRENTE")) {
							System.out.println("A transferÃªncia feita por contas corrente tem uma taxa de R$0,20.");
						}
						System.out.print("AgÃªncia: ");
						agencia = read.nextInt();
						for (int i = 0; i < listaAgencias.size(); i++) {
					...
					case 5:
						if (listaAgencias.get(posicao1).getListaContas().get(posicao2).getTipoConta().name()
								.equals("CORRENTE")) {
							System.out.println("SimulaÃ§Ã£o disponÃ­vel apenas para contas poupanÃ§a.");
						} else {
							System.out.println("Valor simulado: ");
							deposito = read.nextDouble();
							System.out.println("Tempo de simulaÃ§Ã£o (meses): ");
							tempo = read.nextInt();
							System.out.println("O montante final Ã© de: R$"
									+ Math.round(deposito * Math.pow(1.005, tempo) * 100.0) / 100.0);
						}
			...
			System.out.println("Dados inseridos invÃ¡lidos!");
		}
	}
